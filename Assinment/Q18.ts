...
// create an array to store travel destination
 let travelDestination:string[]=["Tokeyu","Brazil","Newyork","London","Azgard"]

// Print your array in its orignal order

console.log("Orignel Order")
console.log(travelDestination)
// Print your array in alphabetical order without modifyoing the actual list
console.log("\n Alphabetical order without modifyoing the actual list")
console.log([...travelDestination].sort())
// show that your array is still in its original order by printing it.
console.log("\nShowing array is still in its original order ")
console.log(travelDestination)
// Print your array in reverse alphabetical order without changing the order of the original list
console.log("\n Reverse Alphabetical order without modifyoing the actual list")
